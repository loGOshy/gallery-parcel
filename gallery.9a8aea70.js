...
refs.galleryList.insertAdjacentHTML('beforeend', createMarkup(_galleryItems.default));
refs.galleryList.addEventListener('click', appearanceOfLightbox);

function createMarkup(images) {
  var galleryMarkup = images.map(function (img) {
    return (// console.log(img);     
      "<li class=\"gallery__item\">\n        <a class=\"gallery__link\"\n          href=\"".concat(img.original, "\">\n          <img\n            class=\"gallery__image\"\n            src=\"").concat(img.preview, "\"\n            loading=\"lazy\"\n            data-source=\"").concat(img.original, "\"\n            alt=\"").concat(img.description, "\"\n          />\n        </a>\n      </li>")
    );
  }).join(' ');
...
function nextImg(objOfImg) {
  var arr = [];
  activImagesRefs.forEach(function (img) {
    return arr.push(img.dataset.source);
  });
  var currentIndex = arr.indexOf(objOfImg.dataset.source);
